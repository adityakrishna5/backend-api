...
/**
 * Tests for SecurityConfig (api-write).
 * @WebMvcTest + @Import loads the real filter chain, covering filterChain().
 * Unit tests cover the jwtConverter lambda branches.
 */
@WebMvcTest(OrderController.class)
@Import(SecurityConfig.class)
@DisplayName("SecurityConfig Tests (api-write)")
